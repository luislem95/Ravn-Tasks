...
export default function Tasks({ state,status,handleDelete,uniqueLabels}) {
    ...
    <div className="grid grid-rows gap-3 m-6">
         {getStatus(status).map((task, index) => (
           ...
           <div className="flex justify-between items-center">
                 ...
                 <div className="mt-3">
                  <ModalDots task={task} handleDelete={handleDelete} uniqueLabels={uniqueLabels}state={state}/>
